    ...
    <div className="row px-xl-5">
      ...
      <div className="col-lg-4">
        <div className="product-offer mb-30" style={{ height: 200 }}>
          <img className="img-fluid" style={{loading:"lazy"}} src="./static/img/offer-1.jpg" alt="" />
        ...
        <div className="product-offer mb-30" style={{ height: 200 }}>
          <img className="img-fluid" style={{loading:"lazy"}} src="./static/img/offer-2.jpg" alt="Offer2" />
          <div className="offer-text">
            <h6 className="text-white text-uppercase">Save 20%</h6>
            <h3 className="text-white mb-3">Special Offer</h3>
            <NavLink to="" className="btn btn-primary">
